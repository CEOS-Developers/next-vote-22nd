...
//<div className={"flex mt-[50px] w-[250px] h-[71px] bg-white border-[4px] border-black justify-end items-center"}
    return (
        <div className=" w-full flex flex-col items-center">
            <Link href={'/demoDayVote'} className={"flex mt-[100px] w-[300px] h-[165px] bg-white border-[4px] border-black justify-end items-center"}>
              ...
              <div className={"flex flex-col items-center mr-[20px] mt-[28px]"}>
                ...
                <div className={`w-[62px] h-[26px] bg-gray-200 border-[1px] border-black rounded-full
                     ...
                     mt-[25px] mb-[12px] flex items-center justify-center`} onClick={() => setChecked2(!checked2)}>
                  결과보기
                </div>
              </div>
            </Link>
