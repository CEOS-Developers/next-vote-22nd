...
export default function PartLeaderStep3Client() {
  const searchParams = useSearchParams();
  const pageTitle = searchParams.get("title") ?? "FE 파트장 투표";
  const [candidates] = useState<Candidate[]>(buildInitialCandidates());
      ...
      <div className="frame-iphone-16 relative flex w-full max-w-md flex-col items-center gap-8 px-8 py-10">
        ...
        <div className="flex w-full flex-col items-center gap-6">
          <div className="flex w-full items-center gap-12">
            <Link
              href={{ pathname: "/partleader/step2", query: { title: pageTitle } }}
